...
static BT_NOTIFICATION_CONFIG_PARAMS g_NotificationConfig[BT_EVENTS_NUM_MAX] =
{
    ...
    ///{"DeviceCreated", ADAPTER_INTERFACE, ARG_STRING},
    /* AUDIO_DEVICE_REMOVED */
    {"DeviceRemoved", AUDIO_MANAGER_INTERFACE, ARG_STRING},
    ///{"DeviceRemoved", ADAPTER_INTERFACE, ARG_STRING},
...
if (connList == NULL) {
    A_DEBUG("No connection found during [%s]\n", __FUNCTION__);
}
...
#ifdef BLUEZ4_3
        /* spawn a thread that will capture HCI events and commands from the adapter */
